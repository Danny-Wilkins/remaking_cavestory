...
Player::Player(Graphics& graphics, float x, float y) :
	AnimatedSprite(graphics, "content/sprites/my_char.png", 0, 0, 16, 16, x, y, 100)
{
	graphics.loadImage("content/sprites/my_char.png");	
	setupAnimations();
...
{
	dx = 0;
	//Syntax: If facing RIGHT IdleRight else IdleLeft
